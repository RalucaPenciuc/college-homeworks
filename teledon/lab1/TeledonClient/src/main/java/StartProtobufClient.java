...
import teledon.network.protobufprotocol.TeledonServerProtobufProxy;
...
public class StartProtobufClient  extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try {
            clientProps.load(StartProtobufClient.class.getResourceAsStream("/teledonclient.properties"));
        ...
        ITeledonServer server = new TeledonServerProtobufProxy(serverIP, serverPort);

        try {
            FXMLLoader loginLoader = new FXMLLoader();
            loginLoader.setLocation(StartProtobufClient.class.getResource("mainWindow.fxml"));
            ...
            cazLoader.setLocation(StartProtobufClient.class.getResource("cazCaritabilWindow.fxml"));
